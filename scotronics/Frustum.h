 ...
 *  MapEditor
 *
 *  Created by Scott Scaccianoce on 6/22/12.
...
#ifndef __GLFRUSTRUM__
#define __GLFRUSTRUM__
...
{
public:
	Frustum(void)       // Set some Reasonable Defaults
	...
	void Transform(GLCamera& camera)
	{
		// Workspace
		M3DMatrix44f rotMat;
